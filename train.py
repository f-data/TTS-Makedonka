...
def eval_model(global_step, writer, device, model, checkpoint_dir, ismultispeaker):
    # harded coded
    texts = [
        "Rabotata se vrakja vo normala po golemite poplavi.",
        "Ako se namali cenata na elektrichnata energija, ELEM kje trpi seriozni zagubi koi kje se reflektiraat ponataka.",
        "Korisnichkiot profil e zatvoren.",
        "Kostadin Mishev i Monika Simjanoska se kralevi na cvetot.",
        "Fustanot na Monika mirisa na taratur.",
        "Kokosot saka golem motor.",
    ]
    import synthesis
